...
<%@ Page Title="Edit Car" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Edit-Car.aspx.cs" Inherits="eCar_Rental_System.Admin.Edit_Car" %>
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <p>
        &nbsp;</p>
    <p>
        <asp:Button ID="Submit_Btn" runat="server" Height="40px" Text="EDIT CAR" Width="10%" BackColor="Black" BorderColor="White" CssClass="btn" Font-Bold="True" Font-Size="Large" ForeColor="White" OnClick="EditCar_Click" />
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
