...
<%@ Page Title="Add Request" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Add-Request.aspx.cs" Inherits="eCar_Rental_System.User.Add_Request" %>
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div style="display:inline-block; vertical-align:top; width: 303px; height: 375px; margin-top: 0px;">
        ...
        <center>
        <asp:Button ID="Submit_Btn" runat="server" Text="MAKE REQUEST" Font-Bold="False" BorderStyle="Solid" BackColor="Black" CssClass="btn" Font-Size="Medium" ForeColor="White" Height="40px" Width="157px" OnClick="Request_Click" />
        </center>
        <br />
    </div>
